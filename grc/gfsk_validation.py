...
# Title: GFSK Validation flowgraph
...
class gfsk_validation(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "GFSK Validation flowgraph")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("GFSK Validation flowgraph")
        ...
        self.settings = Qt.QSettings("GNU Radio", "gfsk_validation")
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.freq_xlating_fir_filter_xxx_0.set_taps(firdes.low_pass(1.0,self.samp_rate,900,200))
...
def main(top_block_cls=gfsk_validation, options=None):
